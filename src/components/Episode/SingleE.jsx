...
import '/src/components/Item/player.css'
import { useParams, Link } from 'react-router-dom'
import { EpisodeContext } from '/src/components/context/EpisodeContext'
                        ...
                        <div className="epidet">
                            <div className="epiposter">
                                ...
                                <div className="flexonlyy">
                                    ...
                                    {anime ? <a rel='noreferrer' style={{ cursor: 'pointer', backgroundImage: url('/src/logo/nyaa.png'), padding: '5px', borderRadius: '10px', backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: 'no-repeat' }} className='fgsdasd nyaa' target='_blank' href={`https://nyaa.si/?q=${tv.name.split("-").join("+")}+S${+sid < 10 ? "0" + sid : sid}+E${+episodes.episode_number < 100 ? "00" + eid : eid}`}>
